...
SELECT a.codigo, SUBSTRING(a.codigo, 0, CHARINDEX('T', a.codigo)+1) as codigo_articulo, a.grupo, a.nombre, a.nombre as descripcion, 1 as cantidad, ROUND(pa.precio, 2) precio, SUBSTRING(a.codigo, CHARINDEX('T', a.codigo)+1, 5) as talla
from dbo.articulos a 
inner join dbo.precios_articulos pa on pa.cod_articulo = a.codigo 
...
"00000020000003000000300000030000003"

"000000980000002000000300000030000003000000300000030000003"
