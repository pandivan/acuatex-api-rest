...
public interface ArticuloRepository extends JpaRepository<Articulo, String>
{
     ...
     */
    @Query(value = 
                  "SELECT SUBSTRING(a.codigo, 0, CHARINDEX('T', a.codigo)+1) as codigo, a.grupo, a.nombre, a.nombre as descripcion, 1 as cantidad, pa.precio, SUBSTRING(a.codigo, CHARINDEX('T', a.codigo)+1, 5) as talla " +
